...
class VideoDemo extends StatefulWidget {
  ...
  final String uri;
  const VideoDemo({Key key, this.title, this.description, this.uri}) : super(key: key);
...
class _VideoDemoState extends State<VideoDemo>
  ...
  void initControllerUri(){
    beeController = new VideoPlayerController.network(widget.uri);
  }
